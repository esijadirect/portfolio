...
// const myFruit = fruit.splice(4, 2, "Lemon", "Kiwi");
// fruit.sort();
// console.log(myFruit);
// console.log(fruit);
...
// //sorting numbers  || read up arrow functions
// const numbers = [9, 5, 14, 18, 6, 97, 4, 909, 1, 7, 10, 23, 25];
...
// // const arr1 = [0, 1, 2];
// // const arr3 = [3, 4, 5];
// // const combined = [...arr1, ...arr3]; // [0, 1, 2, 3, 4, 5]
...
// const myStudents = function () {
//     for (let i = 0; i < students.length; i++) {
//         console.log(`${students[i].id}   ${students[i].cgpa}   ${students[i].university}   ${students[i].courses}`)
//     }
// }
// myStudents();

// const myCgpa = function () {
//     for (let i = 0; i < students.length; i++) {
